...
function Data() {
    return (
        <div className="home_data">
            ...
            <h3 className="home_subtitle">Junior Game Developer | Front-End Developer & UI/UX Enthusiast </h3>
            <p className="home_description">Hi... &#128075;  I'm Ariq Naufal Fadhlurrahman. You can call me Ariq. I am an experienced game developer with a strong understanding of game engines and programming languages such as Unity and C#. Intermediate level skilled front-end developer with a strong understanding of web development technologies such as HTML, CSS, JavaScript and ReactJS </p>
